...
class MainWindow(QMainWindow):
    ...
    def send_to_left_Button(self):
        ...
        selected_username = self.model_right.item(row_to_send, 1).text()
        selected_user_last_name = self.model_right.item(
            row_to_send, 2).text()
        ...
        self.db.add_user(selected_username,
    ...
    def send_to_right_Button(self):
        ...
        selected_username = self.model_left.item(row_to_send, 1).text()
        selected_user_last_name = self.model_left.item(row_to_send, 2).text()
        ...
        self.db.add_user_r(selected_username,
                           selected_user_last_name,
                           selected_user_password)
